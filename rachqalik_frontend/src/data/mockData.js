...
export const PRODUCT_CATEGORIES = [
  ...
  { slug: 'classic',      label: 'Classique Intelligent' },
  { slug: 'ergonomic',    label: 'Ergonomique Intelligent' },
]
...
export const MOCK_PRODUCTS = [
  ...
  {
    _id: 'prod008',
    name: 'Rachqalik Classic',
    price: 650,
    description:
      "L'entrée idéale dans l'univers du sommeil connecté. Le Rachqalik Classic intègre discrètement nos capteurs de suivi basique directement dans un oreiller à confort standard : suivi de la durée de sommeil, détection des phases de réveil et rapport quotidien dans l'application gratuite. Garnissage microfibre hypoallergénique, housse en polyester respirant lavable en machine. Pack Standard inclus : accès à l'application avec fonctionnalités essentielles.",
    image: '/products/adjustable_pillow.jpg',
    stock: 200,
    category: 'classic',
    pack: 'standard',
  ...
  {
    _id: 'prod009',
    name: 'Rachqalik Ergo Pro',
    price: 1099,
    description:
      "Conçu pour ceux qui veulent vraiment optimiser leur sommeil. Le Rachqalik Ergo Pro combine un design ergonomique spécifiquement étudié pour le cou et la colonne vertébrale — deux zones de loft pour dos et côté — avec des capteurs de précision supérieure qui mesurent les micro-mouvements de tête, la fréquence cardiaque et la cohérence respiratoire. Le Pack Premium débloque des analyses avancées (courbes de cycles, score HRV, tendances sur 30 jours) et un coaching sommeil personnalisé directement dans l'application. Mousse à mémoire certifiée CertiPUR-US, housse bambou machine-washable.",
    image: '/products/comfort_back.webp',
    stock: 85,
    category: 'ergonomic',
    pack: 'premium',
